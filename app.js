...
global.getUserMedia = navigator.mozGetUserMedia || navigator.webkitGetUserMedia || navigator.getUserMedia;
if (getUserMedia) {
...
var Wad = (function () {
    ...
    var getConsent = function (that, arg) {
        ...
        getUserMedia({ audio: true, video: false }, function (stream) {
            ...
            console.log("Error setting up microphone input: ", error);
    ...
    function autoCorrelate(buf, sampleRate) {
        ...
        for (var offset = MIN_SAMPLES; offset <= MAX_SAMPLES; offset++) {
            ...
            if (correlation > 0.9 && correlation > lastCorrelation) foundGoodCorrelation = true;else if (foundGoodCorrelation) {
    ...
    Wad.Poly.prototype.setUp = function (arg) {
        ...
        if (!(typeof Recorder === "undefined") && arg.recConfig) {
            // Recorder should be defined, unless you're running the unconcatenated source version and forgot to include recorder.js.
    ...
    **/
    ...
    global.midiMap = function (event) {
        ...
        if (event.data[0] === 144) {
            ...
            if (event.data[1] == 46) {
                if (event.data[2] == 127) {
                    Wad.midiInstrument.pedalMod = true;
                } else if (event.data[2] == 0) {
                    Wad.midiInstrument.pedalMod = false;
                }
            }
    ...
    Wad.presets = {
        hiHatClosed: { source: "noise", env: { attack: 0.001, decay: 0.008, sustain: 0.2, hold: 0.03, release: 0.01 }, filter: { type: "highpass", frequency: 400, q: 1 } },
        snare: { source: "noise", env: { attack: 0.001, decay: 0.01, sustain: 0.2, hold: 0.03, release: 0.02 }, filter: { type: "bandpass", frequency: 300, q: 0.18 } },
        hiHatOpen: { source: "noise", env: { attack: 0.001, decay: 0.008, sustain: 0.2, hold: 0.43, release: 0.01 }, filter: { type: "highpass", frequency: 100, q: 0.2 } },
        ghost: { source: "square", volume: 0.3, env: { attack: 0.01, decay: 0.002, sustain: 0.5, hold: 2.5, release: 0.3 }, filter: { type: "lowpass", frequency: 600, q: 7, env: { attack: 0.7, frequency: 1600 } }, vibrato: { attack: 8, speed: 8, magnitude: 100 } },
        piano: { source: "square", volume: 1.4, env: { attack: 0.01, decay: 0.005, sustain: 0.2, hold: 0.015, release: 0.3 }, filter: { type: "lowpass", frequency: 1200, q: 8.5, env: { attack: 0.2, frequency: 600 } } }
    };
    return Wad;
})();
...
var Wad = _interopRequire(require("./bower_components/Wad/src/wad"));

var synthIcon = _interopRequire(require("./icons/synth1.svg"));

var bassIcon = _interopRequire(require("./icons/bass1.svg"));

var ghostIcon = _interopRequire(require("./icons/ghost.svg"));

var hatIcon = _interopRequire(require("./icons/hihat.svg"));

var kickIcon = _interopRequire(require("./icons/kick.svg"));
...
},{"./bower_components/Wad/src/wad":1,"./icons/bass1.svg":6,"./icons/ghost.svg":7,"./icons/hihat.svg":8,"./icons/kick.svg":9,"./icons/synth1.svg":10,"object.assign":17}],12:[function(require,module,exports){
"use strict";
...
module.exports = React.createClass({
    displayName: "exports",
    render: function () {
        return React.createElement("style", { dangerouslySetInnerHTML: { __html: this.props.style } });
    }
});
...
module.exports = React.createClass({
    ...
    render: function () {
        ...
        var props = Object.keys(this.props).reduce(function (_props, prop) {
            if (prop == "svg") return _props;
            _props[prop] = _this.props[prop];
            return _props;
        }, {});
        if (svg.indexOf("data:image") == 0) svg = svg.slice(svg.indexOf("<svg"));
        return React.createElement("div", _extends({}, props, { dangerouslySetInnerHTML: { __html: svg } }));
    }
});
...
},{"object-keys":21}],16:[function(require,module,exports){
'use strict';
...
},{"./hasSymbols":15,"function-bind":20,"object-keys":21}],17:[function(require,module,exports){
'use strict';
...
},{"./implementation":16,"./polyfill":23,"./shim":24,"define-properties":18}],18:[function(require,module,exports){
'use strict';
...
},{"foreach":19,"object-keys":21}],19:[function(require,module,exports){
...
},{"./implementation":16}],24:[function(require,module,exports){
'use strict';
...
},{"./polyfill":23,"define-properties":18}],25:[function(require,module,exports){
'use strict';
...
},{"./CSSProperty":28,"./ReactPerf":96,"./dangerousStyleValue":130,"_process":185,"fbjs/lib/ExecutionEnvironment":155,"fbjs/lib/camelizeStyleName":157,"fbjs/lib/hyphenateStyleName":168,"fbjs/lib/memoizeStringOnly":175,"fbjs/lib/warning":180}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":47,"./PooledClass":48,"_process":185,"fbjs/lib/invariant":169}],31:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":36,"./ReactMultiChildUpdateTypes":92,"./ReactPerf":96,"./setInnerHTML":149,"./setTextContent":150,"_process":185,"fbjs/lib/invariant":169}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":185,"fbjs/lib/invariant":169}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":34,"./ReactPerf":96,"./quoteAttributeValueForBrowser":147,"_process":185,"fbjs/lib/warning":180}],36:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":185,"fbjs/lib/ExecutionEnvironment":155,"fbjs/lib/createNodesFromMarkup":160,"fbjs/lib/emptyFunction":161,"fbjs/lib/getMarkupWrap":165,"fbjs/lib/invariant":169}],37:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginRegistry":41,"./EventPluginUtils":42,"./ReactErrorUtils":81,"./accumulateInto":127,"./forEachAccumulated":135,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],41:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":185,"fbjs/lib/invariant":169}],42:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":39,"./ReactErrorUtils":81,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],43:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":39,"./EventPluginHub":40,"./accumulateInto":127,"./forEachAccumulated":135,"_process":185,"fbjs/lib/warning":180}],44:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":98,"./ReactPropTypes":99,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],47:[function(require,module,exports){
/**
...
},{"_process":185,"fbjs/lib/invariant":169}],49:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactInstanceMap":87,"./findDOMNode":133,"_process":185,"fbjs/lib/warning":180}],51:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":101,"./instantiateReactComponent":143,"./shouldUpdateReactComponent":151,"./traverseAllChildren":152,"_process":185,"fbjs/lib/warning":180}],53:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"./ReactComponent":55,"./ReactElement":77,"./ReactNoopUpdateQueue":94,"./ReactPropTypeLocationNames":97,"./ReactPropTypeLocations":98,"_process":185,"fbjs/lib/emptyObject":162,"fbjs/lib/invariant":169,"fbjs/lib/keyMirror":172,"fbjs/lib/keyOf":173,"fbjs/lib/warning":180}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":94,"./canDefineProperty":129,"_process":185,"fbjs/lib/emptyObject":162,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],56:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":185,"fbjs/lib/invariant":169}],58:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":47,"./ReactComponentEnvironment":57,"./ReactCurrentOwner":59,"./ReactElement":77,"./ReactInstanceMap":87,"./ReactPerf":96,"./ReactPropTypeLocationNames":97,"./ReactPropTypeLocations":98,"./ReactReconciler":101,"./ReactUpdateQueue":107,"./shouldUpdateReactComponent":151,"_process":185,"fbjs/lib/emptyObject":162,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],59:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":59,"./ReactDOMTextComponent":71,"./ReactDefaultInjection":74,"./ReactInstanceHandles":86,"./ReactMount":90,"./ReactPerf":96,"./ReactReconciler":101,"./ReactUpdates":108,"./ReactVersion":109,"./findDOMNode":133,"./renderSubtreeIntoContainer":148,"_process":185,"fbjs/lib/ExecutionEnvironment":155,"fbjs/lib/warning":180}],61:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":77,"./ReactElementValidator":78,"_process":185,"fbjs/lib/mapObject":174}],64:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":33,"./DOMPropertyOperations":35,"./ReactMount":90,"./ReactPerf":96,"_process":185,"fbjs/lib/invariant":169}],66:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":46,"./Object.assign":47,"./ReactDOMIDOperations":65,"./ReactMount":90,"./ReactUpdates":108,"_process":185,"fbjs/lib/invariant":169}],67:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":47,"./ReactChildren":53,"./ReactDOMSelect":68,"_process":185,"fbjs/lib/warning":180}],68:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":46,"./Object.assign":47,"./ReactMount":90,"./ReactUpdates":108,"_process":185,"fbjs/lib/warning":180}],69:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMChildrenOperations":33,"./DOMPropertyOperations":35,"./Object.assign":47,"./ReactComponentBrowserEnvironment":56,"./ReactMount":90,"./escapeTextContentForBrowser":132,"./setTextContent":150,"./validateDOMNesting":153,"_process":185}],72:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":46,"./Object.assign":47,"./ReactDOMIDOperations":65,"./ReactUpdates":108,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],73:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"./ReactCurrentOwner":59,"./canDefineProperty":129,"_process":185}],78:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":59,"./ReactElement":77,"./ReactPropTypeLocationNames":97,"./ReactPropTypeLocations":98,"./canDefineProperty":129,"./getIteratorFn":140,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],79:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":103,"_process":185,"fbjs/lib/invariant":169}],87:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"./ReactChildren":53,"./ReactClass":54,"./ReactComponent":55,"./ReactDOMFactories":63,"./ReactElement":77,"./ReactElementValidator":78,"./ReactPropTypes":99,"./ReactVersion":109,"./onlyChild":146,"_process":185}],89:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildReconciler":52,"./ReactComponentEnvironment":57,"./ReactCurrentOwner":59,"./ReactMultiChildUpdateTypes":92,"./ReactReconciler":101,"./flattenChildren":134,"_process":185}],92:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"_process":185,"fbjs/lib/invariant":169}],94:[function(require,module,exports){
(function (process){
/**
...
},{"_process":185,"fbjs/lib/warning":180}],95:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"_process":185,"fbjs/lib/invariant":169}],96:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactDefaultBatchingStrategy":73,"./ReactElement":77,"./ReactInstanceHandles":86,"./ReactMarkupChecksum":89,"./ReactServerBatchingStrategy":104,"./ReactServerRenderingTransaction":106,"./ReactUpdates":108,"./instantiateReactComponent":143,"_process":185,"fbjs/lib/emptyObject":162,"fbjs/lib/invariant":169}],106:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"./ReactCurrentOwner":59,"./ReactElement":77,"./ReactInstanceMap":87,"./ReactUpdates":108,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],108:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":30,"./Object.assign":47,"./PooledClass":48,"./ReactPerf":96,"./ReactReconciler":101,"./Transaction":125,"_process":185,"fbjs/lib/invariant":169}],109:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":39,"./EventPropagators":43,"./ReactMount":90,"./SyntheticClipboardEvent":114,"./SyntheticDragEvent":116,"./SyntheticEvent":117,"./SyntheticFocusEvent":118,"./SyntheticKeyboardEvent":120,"./SyntheticMouseEvent":121,"./SyntheticTouchEvent":122,"./SyntheticUIEvent":123,"./SyntheticWheelEvent":124,"./getEventCharCode":136,"_process":185,"fbjs/lib/EventListener":154,"fbjs/lib/emptyFunction":161,"fbjs/lib/invariant":169,"fbjs/lib/keyOf":173}],114:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"./PooledClass":48,"_process":185,"fbjs/lib/emptyFunction":161,"fbjs/lib/warning":180}],118:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":185,"fbjs/lib/invariant":169}],126:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":185,"fbjs/lib/invariant":169}],128:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"_process":185,"fbjs/lib/warning":180}],132:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":59,"./ReactInstanceMap":87,"./ReactMount":90,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],134:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":152,"_process":185,"fbjs/lib/warning":180}],135:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":47,"./ReactCompositeComponent":58,"./ReactEmptyComponent":79,"./ReactNativeComponent":93,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],144:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":77,"_process":185,"fbjs/lib/invariant":169}],147:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":59,"./ReactElement":77,"./ReactInstanceHandles":86,"./getIteratorFn":140,"_process":185,"fbjs/lib/invariant":169,"fbjs/lib/warning":180}],153:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":47,"_process":185,"fbjs/lib/emptyFunction":161,"fbjs/lib/warning":180}],154:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 *
...
},{"./emptyFunction":161,"_process":185}],155:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":155,"./createArrayFromMixed":159,"./getMarkupWrap":165,"./invariant":169,"_process":185}],161:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":155,"./invariant":169,"_process":185}],166:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":185}],170:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":169,"_process":185}],173:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":169,"_process":185}],180:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":161,"_process":185}],181:[function(require,module,exports){
'use strict';
...
var Firebase = _interopRequire(require("firebase/lib/firebase-web"));

var Shake = _interopRequire(require("shake.js"));

var Svg = _interopRequire(require("@asbjornenge/react-svg"));
...
var babysmile = _interopRequire(require("./icons/babysmile.svg"));

var babyhappy = _interopRequire(require("./icons/babyhappy.svg"));

var babylove = _interopRequire(require("./icons/babylove.svg"));

var firebase = new Firebase("https://distributed-dub-step.firebaseio.com/instruments");
var instrument = random();
var _instrument = firebase.push(instrument);
_instrument.onDisconnect().remove();

var myshake = new Shake({
    threshold: 10, // optional shake strength threshold
    timeout: 100 // optional, determines the frequency of event generation
});
myshake.start();

var DistributedDubStepPlayer = (function (_React$Component) {
    function DistributedDubStepPlayer(props) {
        _classCallCheck(this, DistributedDubStepPlayer);

        _get(Object.getPrototypeOf(DistributedDubStepPlayer.prototype), "constructor", this).call(this, props);
        this.state = {
            shakeValue: 0
        };
    }

    _inherits(DistributedDubStepPlayer, _React$Component);

    _prototypeProperties(DistributedDubStepPlayer, null, {
        render: {
            value: function render() {
                var largestDelta = this.state.shakeValue;
                var baby = babysad;
                ...
                return React.createElement(
                    "div",
                    { className: "DistributedDubStepPlayer" },
                    React.createElement(Style, { style: playerStyle }),
                    React.createElement(
                        "div",
                        { className: "mask" },
        ...
        setShakeValues: {
            value: function setShakeValues() {
                var shakeValue = this.shakeDeltas.reduce(function (max, deltas) {
                    var _max = deltas.x;
    ...
    return DistributedDubStepPlayer;
})(React.Component);
